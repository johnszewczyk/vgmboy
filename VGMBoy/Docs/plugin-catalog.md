...
| `ffmpeg-audio` | Homebrew FFmpeg 8.1.2_1 | `CFFmpeg` | `vgmboy-ffmpeg-inspect` | APE (Monkey's Audio), MP2, and TAK; one finite decoded stream |
...
| --- | --- | --- |
| FFmpeg | 8.1.2_1 | `CFFmpeg` APE/MP2/TAK support and vgmstream build input; `vgmboy-ffmpeg-inspect` is the ScanSong metadata handoff |
