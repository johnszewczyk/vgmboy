...
| --- | --- | --- |
| `SPCBoy/SPCBoy-electron.zip` | `454a99e941bc622877fdf6821a0b7256fa30514f004d65e0f19d24962e80eee4` | Verified legacy Electron SPCBoy recovery archive from the legacy checkout staging tree. Git history is kept in `archive/SPCBoy/...`; LaunchPad targets SPCBoyWK. |
