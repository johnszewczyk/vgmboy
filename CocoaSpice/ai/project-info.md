...
- UAC member playback boundary: [player-integration.md](/Users/john/Downloads/Code/VGMMan/UACMan/ai/subsystem-agent/player-integration.md)
...
- UAC's manifest and seek-table contract belongs to UACMan; CocoaSpice owns only its host codec and playback adapters.
