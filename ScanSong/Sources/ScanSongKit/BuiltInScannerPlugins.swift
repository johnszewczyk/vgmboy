...
public enum BuiltInScannerPlugins {
    ...
    public static let directVGMStreamExtensions =
        VGMStreamFormatManifest.directScannerExtensions.subtracting(["ads", "adp", "adx", "ahx", "at3", "aus", "bika", "dvi", "mib", "msf", "ss2", "strm", "svag", "thp", "xa", "xmd"])
    ...
    private static let decoderMetadataDescriptors: [ScannerPluginDescriptor] = [
        ...
        .init(pluginID: "vgmstream", displayName: "vgmstream", supportedExtensions: directVGMStreamExtensions.union(["ads", "adp", "adx", "ahx", "at3", "aus", "dvi", "mib", "msf", "ss2", "strm", "svag", "thp", "xa", "xmd"]), structurePolicy: .enumerate, metadataPolicy: .decoder, priority: 10)
    ]
