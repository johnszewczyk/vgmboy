...
const refs = {
  ...
  playlistBodyWrap: document.querySelector(".playlist-scroll-wrap"),
  playlistSelectionIndicator: document.getElementById("playlist-selection-indicator"),
  playlistHeaderRow: document.querySelector(".playlist-table thead tr"),
  playlistBodyTable: document.querySelector(".playlist-table"),
