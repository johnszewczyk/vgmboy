...
ViewBoy obtains transport state, elapsed position, decoder statistics, and reached-end state
...
completion is delivered as a native end event. Playback timing remains owned by VGMBoy; ViewBoy
...
and restore the shared output envelope before continuing. Delayed ViewBoy fade callbacks also
