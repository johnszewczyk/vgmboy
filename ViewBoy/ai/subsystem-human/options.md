...
- Interface is the fixed Game Boy Core presentation: sampled gray plastic, maroon accents, fine LCD pixel dots, a pea-green playlist, and bundled Doto. Interface Scale applies one 8–18 pt size across the player, library, playlist, and Settings. Text color and accent remain adjustable.
