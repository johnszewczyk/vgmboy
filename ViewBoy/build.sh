...
APP_DIR="$BUILD_DIR/ViewBoy.app"
BUNDLE_IDENTIFIER="com.john.viewboy"
DEVELOPMENT_SIGNING_IDENTITY="${VIEWBOY_SIGNING_IDENTITY:-${SPCBOY_SIGNING_IDENTITY:-${COCOASPICE_SIGNING_IDENTITY:-1D46142A0CE920B12207A97C60E9DD3C389E4144}}}"
...
EXECUTABLE="$BIN_DIR/ViewBoy"
RESOURCE_BUNDLE="$BIN_DIR/ViewBoy_ViewBoy.bundle"
