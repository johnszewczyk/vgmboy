...
extension FrontendPreferencesKeySet {
    static let viewBoy = FrontendPreferencesKeySet(
        autoResizeEnabledKey: "ViewBoy.autoResizeAnimationEnabled",
        selectionEnabledKey: "ViewBoy.selectionAnimationEnabled",
        autoResizeMillisecondsKey: "ViewBoy.autoResizeAnimationMilliseconds",
        selectionMillisecondsKey: "ViewBoy.selectionAnimationMilliseconds",
        columnAutoSizeKey: "ViewBoy.columnAutoSize",
        mainWindowAlwaysOnTopKey: "ViewBoy.mainWindowAlwaysOnTop",
        settingsWindowAlwaysOnTopKey: "ViewBoy.settingsWindowAlwaysOnTop"
    )
}
