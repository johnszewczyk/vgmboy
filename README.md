...
without copying its database model or UI state into each skin. CocoaSpice's
persistent archive cache and scan-time full-archive extraction remain
app-specific until their ownership and cache policy are ported deliberately.
