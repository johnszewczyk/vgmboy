...
- `MediaScannerKit`: versioned scanner types, host-neutral metadata and result records, format-routing policy, incremental planning, archive/decoder plugin protocols, cancellation-aware resource scheduling, and dry-run probing.
