...
func supportedFormatsAreRegisteredAsDirectFormatDataParsers() {
    ...
    #expect(formats.map(\.identifier) == ["ay", "sap", "nsf", "gbs", "nsfe", "hes", "sndh", "kss", "s98", "vgm", "psf-family", "gsf", "qsf", "spc", "sid", "ape", "adx", "aus", "at3", "msf", "svag", "xmd", "sony-sshd", "ps-headerless-mib", "bink-audio", "ngc-dtk-adp", "txth-ima-adp", "ahx", "dvi", "xa", "nds-strm", "nds-strm-ffta2", "ngc-dsp-standard", "rs03", "ngc-thp-audio"])
