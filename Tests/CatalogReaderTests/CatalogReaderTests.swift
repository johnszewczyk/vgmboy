...
private func fixtureCatalog() throws -> URL {
    ...
    try execute(database, """
        ...
        CREATE TABLE library_roots (id INTEGER PRIMARY KEY, path TEXT NOT NULL, is_enabled INTEGER NOT NULL, is_attached INTEGER NOT NULL, last_scan_track_count INTEGER NOT NULL);
