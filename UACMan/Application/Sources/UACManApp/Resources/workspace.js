(() => {
  ...
  function renderTagScopePage(title, scope, includeAttachments = false) {
    ...
    const createRow = scope => `<form class="field-grid-row tag-create-row" data-tag-create data-tag-scope="${scope}" role="row"><div class="field-grid-cell tag-create-number" role="cell"><span class="tag-create-marker">＋</span></div><div class="field-grid-cell" role="cell"><span class="tag-create-type">string</span></div><div class="field-grid-cell" role="cell"><input class="tag-table-field" data-new-tag-key placeholder="Tag Name" aria-label="New tag name"></div><div class="field-grid-cell" role="cell"><input class="tag-table-field" data-new-tag-value placeholder="Tag Value" aria-label="New tag value"></div><div class="field-grid-cell" role="cell"><span class="tag-create-hint">new</span></div><div class="field-grid-cell tag-submit-cell" role="cell"><button class="icon-button" type="submit" title="Add tag" aria-label="Add tag">✓</button></div><div class="field-grid-cell tag-delete-cell" role="cell"></div></form>`;
    ...
    const canonicalGrid = (gridTitle, rows, popups, gridScope) => `<section class="tag-scope-table"><div class="section-title"><span>${gridTitle}</span><span class="section-help">Package-level metadata</span></div><div class="data-table-scroll canonical-table-surface"><div class="field-grid canonical-table flat-table meta-field-grid" role="table" aria-label="${gridTitle}">${header}${createRow(gridScope)}${rows || '<div class="field-grid-empty" role="row"><span role="cell">No tags</span></div>'}</div></div>${popups.join("")}</section>`;
