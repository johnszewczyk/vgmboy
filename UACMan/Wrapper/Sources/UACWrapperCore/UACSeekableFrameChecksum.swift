...
/// The low 32 bits of XXH64 over a decompressed Zstandard seekable frame.
/// Kept with the container contract so playback and metadata tools validate
/// the same on-disk checksum semantics.
